...
public class AccidentalInsurancePlan extends InsurancePlan {
	...
	public String toString() {
		return "AccidentalInsurancePlan [disabilityCoveragePercentage=" + disabilityCoveragePercentage + ", internationalCoverage="
				+ internationalCoverage + ", planNo=" + planNo + ", planName=" + planName + ", tenure=" + tenure
				+ ", premiumAmount=" + premiumAmount + ", insuredAmount=" + insuredAmount + ", status=" + status + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ Objects.hash( disabilityCoveragePercentage, internationalCoverage);
		return result;
	}
