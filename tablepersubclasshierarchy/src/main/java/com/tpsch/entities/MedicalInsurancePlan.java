...
public class MedicalInsurancePlan extends InsurancePlan {
	...
	public String toString() {
		return "MedicalInsuranceplan [ copay=" + copay
				+ ", coverageType=" + coverageType + ", planNo=" + planNo + ", planName=" + planName + ", tenure="
				+ tenure + ", premiumAmount=" + premiumAmount + ", insuredAmount=" + insuredAmount + ", status="
				+ status + "]";
	}
