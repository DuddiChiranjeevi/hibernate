...
@Entity
@Table(name="medical_insrance-plan")
public class MedicalInsurancePlan extends InsurancePlan{
	...
	public String toString() {
		return "AccidentalInsurancePlan [copay=" + copay + ", coverageType=" + coverageType + ", planNo=" + planNo
				+ ", planName=" + planName + ", tenure=" + tenure + ", premiumAmount=" + premiumAmount + ", insuredAmount="
				+ insuredAmount + ", status=" + status + "]";
	}
